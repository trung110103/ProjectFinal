    ...
    <div v-if="open" class="fixed flex justify-center items-center z-20 inset-0 bg-black bg-opacity-50 h-[100vh] w-full" >
        <div  class=" bg-white w-full max-auto md:w-1/2">
            <div class="text-center relative">
                <h1 class="uppercase font-bold text-xl bg-[#271511] text-white p-2">Thêm sản phẩm</h1>
                <div @click="close">
            ...
            <div class="flex flex-col gap-5 p-5">
                ...
                <button @click="handleAdd" class="float-end p-2 bg-blue-400 shadow-md z-10 rounded-md">Lưu</button>
            </div>
        </div>
    </div>
</template>
